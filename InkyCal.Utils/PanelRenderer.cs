...
namespace InkyCal.Utils
{
	...
	public abstract class PanelRenderer<TPanel> : IPanelRenderer<TPanel> where TPanel : Panel
	{
		...
		/// </summary>
		/// <param name="panel">The panel.</param>
		/// <remarks>A some attributes can be manipulated and sent to <see cref="GetImage(int, int, Color[], IPanelRenderer.Log)"/>, when overriding it not recommended storing the <see cref="Panel.Width"/>, <see cref="Panel.Height"/> or other attributes derived .</remarks>
