...
[assembly: SuppressMessage("Major Code Smell", "S3358:Ternary operators should not be nested", Justification = "Yes this needs clarification", Scope = "member", Target = "~M:InkyCal.Utils.Calendar.ICalExtensions.GetEvents(Ical.Net.CalendarCollection,System.DateTime,System.Text.StringBuilder)~System.Collections.Generic.List{InkyCal.Utils.Calendar.Event}")]
...
[assembly: SuppressMessage("Minor Code Smell", "S3267:Loops should be simplified with \"LINQ\" expressions", Justification = "No fix (found yet) for AsyncEnumerable where clause", Scope = "member", Target = "~M:InkyCal.Utils.Calendar.GoogleCalenderExtensions.ListGoogleCalendars(System.Collections.Generic.IEnumerable{InkyCal.Models.GoogleOAuthAccess},System.Func{InkyCal.Models.GoogleOAuthAccess,System.Threading.CancellationToken,System.Threading.Tasks.Task},System.Threading.CancellationToken)~System.Collections.Generic.IAsyncEnumerable{System.ValueTuple{System.Int32,Google.Apis.Oauth2.v2.Data.Userinfo,Google.Apis.Calendar.v3.Data.CalendarListEntry}}")]

[assembly: SuppressMessage("Style", "VSSpell001:Spell Check", Justification = "Utils is the namespace name", Scope = "module")]
